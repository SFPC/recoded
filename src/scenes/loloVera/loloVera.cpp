...
//    parameters.add(param);
    ...
    fog_min.set("Fog min",570.0,0.0,2048.0);
    fog_max.set("Fog max",870.0,0.0,2048.0);
    extrude.set("EXTRUDE_LINES",10.0,1.0,20.0);
    z_cam.set("CAM_Z_POS",0.0,-500.0,500.0);
...
void loloVera::draw(){
    ...
    for(int i=0;i<lines.size();i++)
    {
       // if(abs(l_index-i) < 20){
        ...
        int _e_limit = 1+extrude*(1.0-show_original_val);
